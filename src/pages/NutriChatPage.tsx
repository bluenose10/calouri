...
import NutriChat from '../components/premium/NutriChat';
...
import { LayoutDashboard, FileBarChart2, LineChart } from 'lucide-react';
...
const NutriChatPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[hsl(var(--app-background))]">
      <DashboardNavbar />
      <main className="container mx-auto px-4 pt-6 pb-10 max-w-6xl flex-grow">
        <SubscriptionBanner />
        {isPremium ? <NutriChat /> : <PremiumAccessBanner />}
      </main>
